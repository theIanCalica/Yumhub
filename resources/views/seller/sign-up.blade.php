...
<body>
    <div class="flex flex-col items-center justify-center px-6 pt-10 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        <div class="flex items-center justify-center mt-96 text-2xl font-semibold lg:mb-10 dark:text-white">
            <img src="{{ asset('logo/logo.png') }}" class="mr-4 h-36 mt-28" alt="Yumhub Logo">
        </div>
        <!-- Card -->
        <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <form class="mt-8 space-y-6" action="#" id="sign-up-form">
                ...
                <button type="submit" style="width: 512px"
                    class="w-full px-5 py-3 text-base font-medium text-center text-white bg-yellow-400 rounded-lg hover:bg-yellow-500 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create
                    account</button>
                <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    Already have an account? <a href="{{ route('sign-in') }}"
                        class="text-yellow-400 hover:underline dark:text-yellow-500">Login here</a>
                </div>
            </form>
        </div>
    </div>
