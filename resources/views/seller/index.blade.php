...
@section('content')
    <div class="px-4 pt-8">
        <!-- Main widget -->
        <div class="p-2 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-3 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-2">
                <div class="flex-shrink-0">
                    <span class="text-base font-bold leading-none text-gray-900 sm:text-lg dark:text-white"
                        id="tot"></span>
                    <h3 class="text-xs font-light text-gray-500 dark:text-gray-400">Sales this year</h3>
                </div>
                <div class="flex items-center justify-end flex-1 text-xs font-medium text-green-500 dark:text-green-400">
                    12.5%
            ...
            <canvas id="main-chart" width="500" height="200"></canvas>

            <!-- Card Footer -->
            <div class="flex items-center justify-between pt-1 mt-2 border-t border-gray-200 dark:border-gray-700">
                <div>
                    <button
                        class="inline-flex items-center p-1 text-xs font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                        type="button" data-dropdown-toggle="weekly-sales-dropdown">Last 7 days <svg
                            class="w-2.5 h-2.5 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    ...
                    <div class="z-50 hidden my-1 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <div class="px-2 py-1" role="none">
                            <p class="text-xs font-medium text-gray-900 truncate dark:text-white" role="none">
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <a href="#"
                                    class="block px-2 py-1 text-xs text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <div class="flex-shrink-0">
                    <a href="#"
                        class="inline-flex items-center p-1 text-xs font-medium uppercase rounded-lg text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">
                        Sales Report
        ...
        <div class="grid w-full grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-3">
            <div
                ...
                <div class="w-full mb-5">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-400">Top Foods</h3>
            ...
            <div
                class="flex flex-col col-span-2 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="w-full">
                    <h3 class="text-base font-bold text-gray-900 dark:text-gray-400">Total order this year</h3>
                    <span class="text-xl font-bold leading-none text-gray-400 dark:text-white">2,340</span>
                    <p class="flex items-center text-base font-normal text-gray-500 dark:text-gray-400 ">
                        Orders per cuisine
                    </p>
                </div>
                <canvas class="w-full" id="cuisine-chart"></canvas>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">YumHub History</h3>
                    <a href="#"
                ...
                <ol class="relative border-l border-gray-200 dark:border-gray-700">
                    <li class="mb-10 ml-4">
                        ...
                        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">July
                            2024</time>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Launch of YumHub 2.0</h3>
                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">YumHub 2.0 is officially
                            launched with enhanced features including real-time order tracking, advanced search filters, and
                            a revamped user interface for a better ordering experience.</p>
                        <a href="#"
                    ...
                    <li class="mb-10 ml-4">
                        ...
                        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">January
                            2024</time>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">YumHub Partners with Local
                            Restaurants</h3>
                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">YumHub forms partnerships
                            with over 50 local restaurants, expanding its food options and offering exclusive discounts for
                            users. This expansion aims to enhance the variety and quality of food available on the platform.
                        </p>
                        <a href="#"
                    ...
                    <li class="mb-10 ml-4">
                        ...
                        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">October
                            2023</time>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Introduction of New Features</h3>
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">New features are introduced on
                            YumHub, including a streamlined checkout process, enhanced payment options, and a personalized
                            recommendation system to improve user experience.</p>
                    </li>
                </ol>
            </div>
                ...
                <div id="carousel" class="relative" data-carousel="">
                    <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                        <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                            ...
                            <h3 class="mb-4 text-2xl font-medium text-gray-900 dark:text-white">Your sales are expected to
                                increase by 30% this quarter</h3>
                            <p class="mb-4 text-gray-500 dark:text-gray-400">Start using our advanced analytics dashboard
                                built with Tailwind CSS and Flowbite. Track your sales, performance metrics, and customer
                                insights effortlessly.</p>
                            <p class="mb-2 text-lg font-medium text-gray-900 dark:text-white">Key Insights:</p>
                            <ul class="pl-4 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                                <li>Understanding the latest trends in customer behavior.</li>
                                <li>How to leverage data to boost sales.</li>
                                <li>Adapting to new market conditions effectively.</li>
                                <li>Utilizing advanced analytics for better decision-making.</li>
                            </ul>
                            <a href="#"
                        ...
                        <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                            ...
                            <p class="mb-4 text-gray-500 dark:text-gray-400">Maximize your marketing, sales, and business
                                growth with our tips and strategies. Enhance your marketing efforts and drive sales
                                effectively!</p>
                            ...
                            <ul role="list" class="pl-2 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                                <li class="flex space-x-2">
                                    ...
                                    <span class="leading-tight">Create dynamic reports and dashboards</span>
                                </li>
                                <li class="flex space-x-2">
                                    <!-- Icon -->
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <span class="leading-tight">Effective customer segmentation strategies</span>
                                </li>
                                <li class="flex space-x-2">
                                    <!-- Icon -->
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <span class="leading-tight">Techniques to boost customer retention</span>
                                </li>
                            </ul>
                            <a href="#"
                                class="inline-flex items-center p-2 font-medium rounded-lg text-teal-700 hover:bg-gray-100 dark:text-teal-500 dark:hover:bg-gray-700">
                                Discover Tips
                                <svg class="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path clip-rule="evenodd" fill-rule="evenodd"
                        ...
                        <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                            <div class="flex items-center mb-4 text-lg font-medium text-indigo-600">
                                <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path clip-rule="evenodd" fill-rule="evenodd"
                                        d="M10 12a4 4 0 11-4-4 4 4 0 014 4zm0 4a8 8 0 01-7.768-6H2a.75.75 0 010-1.5h.232A8 8 0 0110 3a.75.75 0 01.768.648A8 8 0 0118 12.75a.75.75 0 01-.75.75h-.232A8 8 0 0110 16z">
                                    </path>
                                </svg>
                                Community Engagement
                            </div>
                            <p class="mb-4 text-gray-500 dark:text-gray-400">Join our community of like-minded individuals
                                and professionals. Share your ideas, get advice, and stay updated with the latest industry
                                trends.</p>
                            <p class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Engage with Us:</p>
                            <ul role="list" class="pl-2 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                                <li class="flex space-x-2">
                                    <!-- Icon -->
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <span class="leading-tight">Participate in discussion forums</span>
                                </li>
                                <li class="flex space-x-2">
                                    <!-- Icon -->
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <span class="leading-tight">Attend webinars and events</span>
                                </li>
                                <li class="flex space-x-2">
                                    <!-- Icon -->
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <span class="leading-tight">Network with industry leaders</span>
                                </li>
                            </ul>
                            <a href="#"
                                class="inline-flex items-center p-2 font-medium rounded-lg text-indigo-700 hover:bg-gray-100 dark:text-indigo-500 dark:hover:bg-gray-700">
                                Join Us
                                <svg class="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path clip-rule="evenodd" fill-rule="evenodd"
                    ...
                    <div class="absolute top-0 left-0 z-30 flex space-x-4 w-full h-full p-2 justify-between">
                        <button type="button"
                            class="inline-flex items-center justify-center w-10 h-10 text-gray-800 rounded-full hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
                            data-carousel-prev>
                            <span class="sr-only">Previous</span>
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd"
                                    d="M12.803 4.6a.75.75 0 010 1.061L8.975 10l3.828 3.828a.75.75 0 11-1.061 1.061l-4.5-4.5a.75.75 0 010-1.061l4.5-4.5a.75.75 0 011.061 0z">
                                </path>
                            </svg>
                        </button>
                        <button type="button"
                            ...
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd"
                                    d="M7.197 15.4a.75.75 0 010-1.061L11.025 10 7.197 6.172a.75.75 0 111.061-1.061l4.5 4.5a.75.75 0 010 1.061l-4.5 4.5a.75.75 0 01-1.061 0z">
                                </path>
                            </svg>
                        </button>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $.ajax({
            type: "GET",
            url: `/api/getTopFoodPerResto/${userID}`,
            dataType: "json",
            success: function(data) {
                console.log(data);
                var labels = data.map((food) => food.name);
                var values = data.map((food) => food.total_quantity);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // Iterate over each item in the data to calculate the total revenue and profit
                data.forEach((item) => {
                    // Convert revenue and profit from string to number
                    ...
                    if (!isNaN(profit)) {
                        totalAnnualProfit += profit; // Add to total profit
                    } else {
                ...
                $("#totProfit").text("₱" + totalAnnualProfit.toLocaleString());
                ...
                const profitData = data.map((item) => item.profit); // Extract monthly profit values
                            ...
                            y: {
                                ...
                                ticks: {
                                    ...
                                    callback: function(value) {
                                        return "₱" + value
                                    .toLocaleString(); // Format y-axis values as currency
                                    },
                                },
                            },
                        },
