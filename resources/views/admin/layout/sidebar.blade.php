        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2 mt-5">
                    ...
                    <li>
                        <a href="{{ route('stockholders') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-yellow-400 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <i class="fi fi-rr-employee-man-alt"></i>
                            <span class="ml-3" sidebar-toggle-item>Stockholders</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('riders') }}"
                        ...
                        <ul id="reports" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ route('users.report') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Users
                                    Report</a>
                            </li>
                            <li>
                                <a href="{{ route('stockholders.report') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stockholders</a>
                            </li>
                            <li>
                                <a href="{{ route('foods.report') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Food
                                    List</a>
                            </li>
                        </ul>
