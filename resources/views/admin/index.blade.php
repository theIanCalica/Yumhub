...
@section('content')
    <div class="px-4 pt-8">
        ...
        <div class="grid w-full grid-cols-1 gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div
                class="flex flex-col p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <h3 class="mb-2 text-base font-normal text-gray-500 dark:text-gray-400">User age groups</h3>
                <div class="flex items-start space-x-4">
                    <div class="flex flex-col items-center">
                        <div class="w-16 text-sm font-medium dark:text-white">18+</div>
                        <div class="relative bg-gray-200 rounded-full h-48 w-2.5 dark:bg-gray-700">
                            <div class="absolute bottom-0 bg-primary-600 h-1/6 rounded-full dark:bg-primary-500 w-full">
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col items-center">
                        ...
                        <div class="relative bg-gray-200 rounded-full h-48 w-2.5 dark:bg-gray-700">
                            <div class="absolute bottom-0 bg-primary-600 h-1/5 rounded-full dark:bg-primary-500 w-full">
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col items-center">
                        ...
                        <div class="relative bg-gray-200 rounded-full h-48 w-2.5 dark:bg-gray-700">
                            <div class="absolute bottom-0 bg-primary-600 h-3/5 rounded-full dark:bg-primary-500 w-full">
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col items-center">
                        ...
                        <div class="relative bg-gray-200 rounded-full h-48 w-2.5 dark:bg-gray-700">
                            <div class="absolute bottom-0 bg-primary-600 h-3/10 rounded-full dark:bg-primary-500 w-full">
                            </div>
                        </div>
                    </div>
                </div>
