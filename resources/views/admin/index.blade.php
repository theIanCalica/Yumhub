        ...
        <div class="p-2 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-3 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-2">
                <div class="flex-shrink-0">
                    <span class="text-base font-bold leading-none text-gray-900 sm:text-lg dark:text-white">$45,385</span>
                    <h3 class="text-xs font-light text-gray-500 dark:text-gray-400">Sales this week</h3>
                </div>
        ...
        $(document).ready(function() {
            ...
            const data = {
                ...
                datasets: [{
                    ...
                    data: [120, 150, 180, 200, 170, 210, 220, 190, 230, 240, 250, 270], // Example data
